...
public:
			...
			diagnostic_updater::Updater &diag_updater)
	{
		...
		rc_in_pub = rc_nh.advertise<mavros::ManualControl>("in", 10);
	...
	const message_map get_rx_handlers() {
		return {
			MESSAGE_HANDLER(MAVLINK_MSG_ID_MANUAL_CONTROL, &RCIOPlugin::handle_rc_channels_raw),
